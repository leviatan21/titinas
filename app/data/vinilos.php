...
function vinilos() {
    return [
        [// Vinilo Blanco Mate 8x11
            'title' => 'Vinilos Blanco Mate 8x11cm',
        ...
        [// Vinilo Blanco Mate 10x10
            'title' => 'Vinilos Blanco Mate 10x10cm',
        ...
        [// Vinilo Blanco Mate 15x15
            'title' => 'Vinilos Blanco Mate 15x15cm',
            'description' => "Ideales para darle una cambio de cara a tu baño o cocina<br />
                            Aptos para pegar sobre vidrio, azulejos, madera, acrílico, plástico, pared, etc<br />
                            También podés realizar guardas poniendo a gusto uno al lado del otro.<br />
                            Presentación: 6 unidades por modelo",
        ...
        [// Etiquetas troqueladas A4
            'title' => 'Vinilo Blanco Mate A4',
            'description' => "Etiquetas troqueladas para frascos<br />
                            Realizadas en vinilo blanco laminado<br />
                            Permite ser lavado sin despegarse ni desgastarse<br />
                            Tamaño: 19x27cm<br />
                            Presentación: Trae en una sola plancha todo lo que necesitas para decorar tu cocina.",
            'image' => asset('/images/productos/vinilos/blanco-mate-a4.webp'),
