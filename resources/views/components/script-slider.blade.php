...
<link href="{{asset('/css/libs/slick-carousel/1.8.1/slick.min.css')}}" rel="stylesheet" type="text/css"/>
@endsection

@section('js')
{{--<script src="//cdn.jsdelivr.net/npm/slick-carousel@1.8.1/slick/slick.min.js" type="text/javascript" defer></script>--}}
<script src="{{asset('/js/libs/slick-carousel/1.8.1/slick.min.js')}}" type="text/javascript" defer></script>
@endsection

<script type="text/javascript">
$(document).ready(function() {
	try {slider()} catch (error) {}
});
...
function slider() {
	$('#featured-slider').slick({
		...
		'dotsClass':'slider-dots','rtl':false,'adaptiveHeight':true,'speed':750,'fade':true,'dots':false,'autoplay':true,'autoplaySpeed':5000,'slidesToShow':1,'slidesToScroll':1
	});
}
</script>