...
function FancyboxDefaults() {
	Fancybox.defaults = {
        ...Fancybox.defaults,
        'compact':false,'idle':false,'animated':false,'showClass':false,'hideClass':false,'dragToClose':false,'contentClick':'toggleZoom','backdropClick':'close',
        'Images':{'initialSize':'fit','protected':true,'zoom':false},
        'Thumbs':{'type':'classic','Carousel':{'center':false}},
