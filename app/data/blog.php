...
function authors() {
    return [
        'roxana-caballero' => [
            'image' => asset('/images/blog/autores/roxana-caballero.webp'),
            'content' => [
                'Mi especialidad es el trabajo de modelado y diseño de objetos a partir de un bollo de masa.',
                'he experimentado mucho con masas de fraguado sin horno.',
                'En mi búsqueda por no depender de la necesidad de un proceso de cocción, he creado una pasta para modelar que denomino <strong>pasta cerámica sin horno</strong>.',
                'Brinda un acabado símil bizcocho cerámico.',
                'Mi impronta en los ojbetos que creo, en mis "Deco-Artes", es la mexcla entre rústico y elegante, lo mdoerno y vanguardista, y siempre, con un alto valor agregado en el diseño y creatividad',
                "2022 y 2023 nos encuentra emprendiendo un nuevo desafío, llevar lo que hacemos a otras tierras.",
                "La marca Titina's continúa en Argentina, mientras me instalo en Italia para poder enseñar allá algo de lo que hacemos. La vida es un constante cambio, y ampliar horizontes siempre está bueno.",
                "Nada nuevo surge i no salimos de la zona de confort. Seguiré estando presente en la redes y en todos los medio de contacto a distancia tanto para nuestros clientes mayoristas como para los ususarios y alumnos de los productos Titina's.",
                "¡Amo lo que hago, y me gusta transmitirlo!"
            ]
        ]
    ];
}